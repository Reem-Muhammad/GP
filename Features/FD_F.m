function [ FD_outputMatrix ] = FD_F( data )
...
%%%%%%%%%FD_outputMatrix = []; %stores the FD values of all channels. each row has the FD values of the windows of a single channel
...
for ch=1:n_channels
    ...
    %%%%%FD_outputMatrix = [FD_outputMatrix; FD_vector_window];
end
